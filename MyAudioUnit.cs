...
namespace Extension13 set import loop name musicscore_audiosystem_
{
    public class MyAudioUnit : AUAudioUnit
    {
        ...
        {
            get in set musiccore_audiosystem _streaming sound _ out _unknows_audio_any analyse audio_ build
            streaming:this analyse sound
            ios _ipad_sound _soundbuild_system;
            {
